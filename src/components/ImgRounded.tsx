...
const ImgRounded = ({ src, size = "md" }: { src: string; size?: TypeSize }) => {
  ...
  return (
    ...
    >
      <Flex
        type="verticalCenter"
        className="rounded-[50%] w-full h-full p-[2px] z-10 bg-gradient-to-tr from-yellow-400 via-red-500 to-pink-500"
      >
        <Flex
          type="verticalCenter"
          className="rounded-[50%] w-full h-full bg-white p-[2px] z-20"
        >
